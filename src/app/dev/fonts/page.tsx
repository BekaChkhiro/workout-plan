      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        <header style={{ marginBottom: 28 }}>
          ...
          <p className="text-body" style={{ color: "var(--color-ink-soft)", marginTop: 6 }}>
            <code>--font-sans</code> chains DM Sans (Latin) → Noto Sans Georgian (Georgian). Loaded
            via <code>next/font/google</code>, self-hosted, no runtime CDN.
          </p>
        </header>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {WEIGHTS.map((w) => (
              <Card key={w.weight}>
                ...
                <div style={{ fontSize: 22, fontWeight: w.weight, marginTop: 6 }}>{SAMPLE}</div>
              </Card>
            ))}
          </div>
        </Section>
